...
const GOOGLE_MAPS_URL = "https://www.google.com/maps/search/?api=1&query=chhatha+mill+sitapur+road+infront+of+Alliance+Lucknow+Uttar+Pradesh";
  ...
  return (
    <div className="bg-primary text-primary-foreground text-sm py-2">
      <div className="container mx-auto section-padding flex items-center justify-between">
        ...
        >
          <MapPin size={14} />
          <span className="hidden sm:inline">Chhatha Mill, Sitapur Road, Infront of Alliance, Lucknow, UP</span>
          <span className="sm:hidden">Lucknow, UP</span>
        </a>
        <div className="flex items-center gap-4">
          ...
          <a href="https:/https://www.instagram.com/kk_sons_06?igsh=NGVmYnlvMGtmcHV3/" target="_blank" rel="noopener noreferrer" className="hover:text-secondary transition-colors" aria-label="Instagram">
          ...
          <a href="https://api.whatsapp.com/send?phone=918303361848" target="_blank" rel="noopener noreferrer" className="hover:text-secondary transition-colors" aria-label="WhatsApp">
